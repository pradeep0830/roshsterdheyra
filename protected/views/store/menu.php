     ...
     <div class="theiaStickySidebar">
      <div class="box-grey rounded  relative">
        ...
        <div class="inner line-top relative delivery-option center">
           ...
           <hr style="margin-top:9px !important; margin-bottom:1px !important;">

		   <!-- start@recurring order-->
		   <div class="recurring_order" style="padding:11px 0px 18px;">
		   <?php if ( $checkout['is_pre_order']==2):?>         
	          <div class="recur-order" style="margin-bottom: 6px !important;">
	           <?php echo CHtml::checkBox('recurring_order',false,array('class'=>"dtr_rc",'id'=>"dtr_rc"))?>
	            <span class="text-muted"><?php echo Yii::t("default","Meal Subscription")?></span>     
	         </div>	
			 <div class="dt_rc" style="display:none;">
			   <?php echo CHtml::textField('start_date_recurring','',array('class'=>"timerange grey-fields",'placeholder'=>Yii::t("default","Repeting Order"),'id'=>"start_date_recurring")); ?>
			   <!--hiden fields for start and end date-->
			   <?php echo CHtml::hiddenField('date_recurring_start','',array('class'=>'date_recurring_start'));?>
			   <?php echo CHtml::hiddenField('date_recurring_end','',array('class'=>'date_recurring_end'));?>
			   <!--end hiden fields for start and end date-->		   
			 </div>    	         	        	     
	         <?php endif;?> 
		   </div>
           <!--end@Recurring order-->	
