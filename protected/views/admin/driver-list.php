<div class="uk-width-1">
    ...
    <a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/driver-add" class="uk-button"><i class="fa fa-plus"></i> <?php echo Yii::t("default","Add New")?></a>
     <a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/driver-list" class="uk-button"><i class="fa fa-list"></i> <?php echo Yii::t("default","List")?></a>
</div>

<form id="frm_table_list" method="POST" >
    <!--<input type="hidden" name="action" id="action" value="driverReviewRating">-->
    <input type="hidden" name="action" id="action" value="driverAjaxList">
    ...
    <table id="table_list" class="uk-table uk-table-hover uk-table-striped uk-table-condensed">
        ...
        <th width="5%"><?php echo Yii::t('default',"ID")?></th>
            ...
            <th width="5%"><?php echo Yii::t('default',"Team Name")?></th>
            <th width="5%"><?php echo Yii::t('default',"Device Name")?></th>
