...
class Functions extends CApplicationComponent
{
    ...
    public function merchantMenu()
    {
        ...
        return array(
            ...
            'items' => array(
                ...
                //sales navigation for merachant
                array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "Orders"), 'tag' => 'Orders', 'label' => '<i class="fa fa-usd"></i>' . Yii::t("default", 'Orders'),
                    'itemOptions' => array('class' => 'has-children'), 'items' => array(
                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "RecurringOrders"), 'tag' => "RecurringOrders", 'label' => Yii::t("default", "Recurring Meals"),
                        'url' => array('/merchant/recurringorders')),

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "AllIncomingOrders"), 'tag' => "AllIncomingOrders", 'label' => Yii::t("default", "Incoming Orders"),
                        'url' => array('/merchant/allincomingorders')),

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "ScheduledOrders"), 'tag' => "ScheduledOrders", 'label' => Yii::t("default", "Scheduled Orders"), 'url' => array('/merchant/scheduledorders')),

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "PickupOrders"), 'tag' => "PickupOrders", 'label' => Yii::t("default", "Pick-up Orders"), 'url' => array('/merchant/pickuporders')),
                )),

                //Food navigation for merachant
                array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "Food"), 'tag' => 'Food', 'label' => '<i class="fa fa-cutlery"></i>' . Yii::t("default", 'Food'),
                    'itemOptions' => array('class' => 'has-children'), 'items' => array(
                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "CategoryList"), 'tag' => "CategoryList", 'label' => Yii::t("default", "Food Category"),
                        'url' => array('/merchant/CategoryList')),

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "category_sked"), 'tag' => "category_sked", 'label' => Yii::t("default", "Food Category Scheduler"),
                        'url' => array('/merchant/category_sked')),

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "Size"), 'tag' => "Size", 'label' => Yii::t("default", "Size"),
                        'url' => array('/merchant/Size')),

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "AddOnCategory"), 'tag' => "AddOnCategory", 'label' => Yii::t("default", "AddOn Category"),
                        'url' => array('/merchant/AddOnCategory')),

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "AddOnItem"), 'tag' => "AddOnItem", 'label' => Yii::t("default", "AddOn Item"),
                        'url' => array('/merchant/AddOnItem')),


                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "ingredients"), 'tag' => "ingredients", 'label' => Yii::t("default", "Ingredients"),
                        'url' => array('/merchant/ingredients')),


                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "CookingRef"), 'tag' => "CookingRef", 'label' => Yii::t("default", "Cooking Reference"),
                        'url' => array('/merchant/CookingRef')),

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "FoodItem"), 'tag' => "FoodItem", 'label' => Yii::t("default", "Food Item"),
                        'url' => array('/merchant/FoodItem')),

                )),

                //Finance navigation for merachant
                array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "Finance"), 'tag' => 'Finance', 'label' => '<i class="fa fa-money"></i>' . Yii::t("default", 'Finance'),
                    'itemOptions' => array('class' => 'has-children'), 'items' => array(
                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "invoice"), 'tag' => "invoice", 'label' => Yii::t("default", "Invoice"),
                        'url' => array('/merchant/invoice')),

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "shippingrate"), 'tag' => "shippingrate", 'label' => Yii::t("default", "Delivery Charges Rates"),
                        'url' => array('/merchant/shippingrate')),

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "mintable"), 'tag' => "mintable", 'label' => Yii::t("default", "Minimum Order Table"),
                        'url' => array('/merchant/mintable')),

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "offers"), 'tag' => "offers", 'label' => Yii::t("default", "Offers"),
                        'url' => array('/merchant/offers')),
                    /*array('visible'=>FunctionsV3::hasMerchantAccessToMenu($user_access,"receiptSettings"),'tag'=>"receiptSettings",'label'=>Yii::t("default","Receipt Settings"),
                    'url'=>array('/merchant/receiptSettings')),*/

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "manage_credit_cards"), 'tag' => "manage_credit_cards", 'label' => Yii::t("default", "Manage Credit Card"),
                        'url' => array('/merchant/manage_credit_cards')),

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "voucher"), 'tag' => "voucher", 'label' => Yii::t("default", "Voucher"),
                ...
                /*addon */
                array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "addon"), 'tag' => 'addon', 'label' => '<i class="fa fa-plus-circle"></i>' . Yii::t("default", 'Addon'),
                    'itemOptions' => array('class' => 'has-children'), 'items' => array(
                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "points_settings"), 'tag' => 'points_settings', 'label' => t("Loyalty Points Settings"),
                        'url' => array('/merchant/points_settings')),

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "printer_merchant_panel"), 'tag' => 'printer_merchant_panel', 'label' => t("Printer Addon"),
                ...
                // commission
                array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "commission"), 'tag' => 'commission', 'label' => '<i class="fa fa-magic"></i>' . Yii::t("default", 'Commission'),
                    'itemOptions' => array('class' => 'has-children'), 'items' => array(

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "statement"), 'tag' => 'statement', 'label' => t("Statement"),
                        'url' => array('merchant/statement')),


                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "earnings"), 'tag' => 'earnings', 'label' => t("Earnings"),
                        'url' => array('merchant/earnings')),

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "withdrawals"), 'tag' => 'withdrawals', 'label' => t("Withdrawals"),
                ...
                array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "sms-gateway"), 'tag' => 'sms-gateway', 'label' => '<i class="fa fa-comment"></i>' . Yii::t("default", 'SMS'),
                    'itemOptions' => array('class' => 'has-children'), 'items' => array(
                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "smsSettings"), 'tag' => 'smsSettings', 'label' => Yii::t("default", "SMS Alert Settings"),
                        'url' => array('merchant/smsSettings')),
                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "smsBroadcast"), 'tag' => 'smsBroadcast', 'label' => Yii::t("default", "SMS BroadCast"),
                        'url' => array('merchant/smsBroadcast')),
                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "purchaseSMS"), 'tag' => 'purchaseSMS', 'label' => Yii::t("default", "Purchase SMS Credit"),
                        'url' => array('merchant/purchasesms')),
                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "purchasesmstransaction"), 'tag' => 'purchasesmstransaction', 'label' => Yii::t("default", "Purchase Credit Transactions"),
                        'url' => array('merchant/purchasesmstransaction')),
                )),

                $fax_menu,

                array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "reports"), 'tag' => 'reports', 'label' => '<i class="fa fa-line-chart"></i>' . Yii::t("default", 'Reports'),
                    'itemOptions' => array('class' => 'has-children'), 'items' => array(
                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "salesReport"), 'tag' => 'salesReport', 'label' => Yii::t("default", "Sales Report"),
                        'url' => array('merchant/salesReport')),
                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "salesSummaryReport"), 'tag' => 'salesSummaryReport', 'label' => Yii::t("default", "Sales Summary Report"),
                        'url' => array('merchant/salesSummaryReport')),

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "bookingreport"), 'tag' => 'bookingreport', 'label' => Yii::t("default", "Booking Summary Report"),
                        'url' => array('merchant/bookingreport')),
                )),

                /*array('tag'=>"home",'label'=>'<i class="fa fa-cog"></i>'.Yii::t("default","Receipt Settings"),
                'url'=>array('/merchant/ReceiptSettings')),*/
                //Review menu for merchant
                array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "Reviews"), 'tag' => 'Reviews', 'label' => '<i class="fa fa-star-half-o"></i>' . Yii::t("default", 'Reviews'),
                    'itemOptions' => array('class' => 'has-children'), 'items' => array(
                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "review"), 'tag' => "review", 'label' => Yii::t("default", "Driver reviews"),
                        'url' => array('/merchant/driverreview')),

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "review"), 'tag' => "review", 'label' => Yii::t("default", "Customer reviews"),
                        'url' => array('/merchant/review')),
                )),
                //Drivers navigation for merachant
                array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "Driver"), 'tag' => 'Driver', 'label' => '<i class="fa fa-taxi"></i> ' . Yii::t("default", 'Driver'),
                    'itemOptions' => array('class' => 'has-children'), 'items' => array(
                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "DriverReports"), 'tag' => "DriverReports", 'label' => Yii::t("default", "Driver Reports"),
                        'url' => array('/merchant/driverreports')),

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "DriverTeam"), 'tag' => "DriverTeam", 'label' => Yii::t("default", "Driver Team"),
                        'url' => array('/merchant/driverteam')),

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "DriverTeam"), 'tag' => "DriverTeam", 'label' => Yii::t("default", "Driver Task List"),
                        'url' => array('/merchant/drivertasklist')),

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "DriverTeam"), 'tag' => "DriverTeam", 'label' => Yii::t("default", "Driver List"),
                        'url' => array('/merchant/driverlist')),
                )),
                //Settings navigation for merachant
                array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "Settings"), 'tag' => 'Settings', 'label' => '<i class="fa fa-cog"></i> ' . Yii::t("default", 'Settings'),
                    'itemOptions' => array('class' => 'has-children'), 'items' => array(
                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "Merchant"), 'tag' => "Merchant", 'label' => Yii::t("default", "Merchant Info"),
                        'url' => array('/merchant/Merchant')),
                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "Settings"), 'tag' => "Settings", 'label' => Yii::t("default", "Settings"),
                    ...
                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "orderStatus"), 'tag' => "orderStatus", 'label' => Yii::t("default", "Order Status"),
                        'url' => array('/merchant/orderStatus')),
                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "AlertSettings"), 'tag' => "AlertSettings", 'label' => Yii::t("default", "Alert Notification"),
                        'url' => array('/merchant/AlertSettings')),

                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "user"), 'tag' => "user", 'label' => Yii::t("default", "User"),
                        'url' => array('/merchant/user')),
                    array('visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "SocialSettings"), 'tag' => "SocialSettings", 'label' => Yii::t("default", "Social Settings"),
    ...
    public function adminMenu()
    {
        return array(
            ...
            'items' => array(
                ...
                array('visible' => $this->AA('packages'),
                    'tag' => "packages", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Driver Reports"),
                    'url' => array('/admin/driver-reports')),
             
                array('visible'=>$this->AA('packages'),
                'tag'=>"packages",'label'=>'<i class="fa fa-list-alt"></i>'.Yii::t("default","Driver Teams"),
				'url'=>array('/admin/DriverTeam')),

				array('visible'=>$this->AA('packages'),
                'tag'=>"packages",'label'=>'<i class="fa fa-list-alt"></i>'.Yii::t("default","Driver Task List"),
				'url'=>array('/admin/DriverTaskList')),

				array('visible'=>$this->AA('packages'),
                'tag'=>"packages",'label'=>'<i class="fa fa-list-alt"></i>'.Yii::t("default","Driver List"),
				'url'=>array('/admin/DriverList')),
                ...
                array('visible' => $this->AA('reviews'), 'tag' => "reviews",
                    'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Driver Reviews"),
                    'url' => array('admin/driverreview')),
    ...
    /**
     * get the recurring details through the order id
     */

    public function getRecurringData($rc_id = '')
    {
        $stmt = "select * from {{order_recurring}} where id=" . FunctionsV3::q($rc_id) . " LIMIT 0,1";
        $connection = Yii::app()->db;
        $rows = $connection->createCommand($stmt)->queryAll();
        if (is_array($rows) && count($rows) >= 1) {
            return $rows[0];
