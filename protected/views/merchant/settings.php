...
<!--Merchant Logo-->
<div class="uk-form-row uk-margin uk-margin">
...
<h3><?php echo t("Order Options")?></h3>
  ...
  <label class="uk-form-label"><?php echo Yii::t("default","Customer can request sms code every")?></label>
    <div class="uk-form-controls">
        <?php echo CHtml::textField('order_sms_code_waiting',getOption($merchant_id,'order_sms_code_waiting'),array(
            'class'=>"numeric_only uk-input uk-width-1-4"
        ))?>
  ...
  <label class="uk-form-label"><?php echo t("Choose option")?></label>
    <div class="uk-form-controls">
        ...
        echo CHtml::dropDownList('merchant_two_flavor_option',
            ...
            ),array("class"=>"uk-select uk-width-1-4"));
        ?>
    </div>
...
<h3><?php echo Yii::t("default","Receipt Options")?></h3>
...
<h3><?php echo Yii::t("default","Printing Options")?></h3>
...
<div class="uk-form-row uk-margin">
  ...
  ,array('class'=>"numeric_only uk-input uk-width-1-4"));
  ?>
...
,array(
  'placeholder'=>t(""),
  'class'=>'uk-form-width-large uk-input uk-width-1-4'
  ));
?>
</div>
...
<?php 
  ...
  'placeholder'=>Yii::t("default","1 hour approx."),'class'=>"uk-input uk-width-1-4"
  ));
  ?>
</div>
...
<?php 
  ...
  Yii::app()->functions->getOption("merchant_distance_type",$merchant_id),Yii::app()->functions->distanceOption(),array('class'=>"uk-select uk-width-1-6"));
  ?>
</div>
...
,Yii::app()->functions->timezoneList(),array(  'class'=>'uk-select uk-width-1-4'))
?>
</div>
