...
<div class="uk-form uk-form-horizontal">
    <div class="uk-form-row uk-text-center uk-grid">
        <div class="col-md-3 uk-width-1-4">
            ...
            <div class="custom_selection top20 uk-text-left">
                <div class="uk-form-row uk-margin">
                    ...
                    <?php echo CHtml::textField('start_date',$start_date,array(
                        'class'=>"uk-form-width-large datetimepicker1 uk-input"
                    ))?>
                </div>
                <div class="uk-form-row uk-margin">
            ...
            <div class="uk-margin uk-text-left">
                ...
                <select name="driver_selection" id="driver_selection" class="driver_selection uk-form-width-large form-control uk-select">
