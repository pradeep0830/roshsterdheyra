<div class="uk-width-1">
    ...
    <a href="<?php echo Yii::app()->request->baseUrl; ?>/merchant/driverreview" class="uk-button"><i class="fa fa-list"></i> <?php echo Yii::t("default","List")?></a>
</div>

<form id="frm_table_list" method="POST" >
    <input type="hidden" name="action" id="action" value="driverReviewRatingAdmin">
