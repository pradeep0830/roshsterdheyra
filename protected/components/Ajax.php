...
$this->msg=t("We have sent bank information instruction to your email")." :$merchant_email";
	...
	public function AllOrders()
	{
		...
		if(!empty($sWhere)){
			$sWhere.=" AND a.status NOT IN ('initial_order') AND a.status  NOT IN ('payment_failed')";
		} else $sWhere.=" WHERE a.status NOT IN ('initial_order') AND a.status  NOT IN ('payment_failed')";
		/*if(!empty($sWhere)){
