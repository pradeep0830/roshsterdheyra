...
<div class="sections section-grey2 section-receipt">
   ...
   <div class="inner" id="receipt-content">
	   ...
	   <br/><h2 style="color: #f75d34;font-weight: bold;font-size: 38px;"><small style="font-size: 15px;vertical-align: super;">Your PIN</small> <?php echo $data['otp']; ?> </h3>	
	   </div>
	   ...
	   <table class="table table-striped">
	    <tbody>	     
	       <!--Order Shift-->
			...
			<td><?php echo Yii::t("default","New Delivery Date")?></td>
	         <td class="text-right">
				 <?php 
	       ...
	       <?php if ($data['trans_type']=="delivery"):?>
		       ...
		       <?php 	       
				...
				?>
				<!--recurring order-->
				<?php if($_SESSION['kr_recurring_order']['start_date']){ ?>				
				<tr>
		         <td colspan="2"><?php echo Yii::t("default","recurring order details")?></td>
			   ...
			   <div class="summary-wrap">
	 				<div class="row">
	 					<div class="col-md-8 col-xs-8 text-right">Start Date:</div>
	 					<div class="col-md-4 col-xs-4 text-right"><?php echo $_SESSION['kr_recurring_order']['start_date'] ?></div>
					</div>
					<div class="row">
	 					<div class="col-md-8 col-xs-8 text-right">End Date:</div>
	 					<div class="col-md-4 col-xs-4 text-right"><?php echo $_SESSION['kr_recurring_order']['end_date'] ?></div>
					</div>
					<div class="row">
	 					<div class="col-md-8 col-xs-8 text-right">Total Day:</div>
	 					<div class="col-md-4 col-xs-4 text-right"><?php echo $_SESSION['kr_recurring_order']['total_day'] ?> Days</div>
					</div>
					<div class="row">
	 					<div class="col-md-8 col-xs-8 text-right">Total Price:</div>
	 					<div class="col-md-4 col-xs-4 text-right"><?php echo displayPrice( baseCurrency(), normalPrettyPrice($_SESSION['kr_recurring_order']['total_total_price']))?></div>
					</div>
				</div>
			   </td>			   
			   </tr> 
