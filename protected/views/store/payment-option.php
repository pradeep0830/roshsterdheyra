     ...
     <div class="col-md-5 border sticky-div"><!-- RIGHT CONTENT STARTS HERE-->
       ...
       <i class="order-icon your-order-icon"></i>
	       ...
	       <div class="order-list-wrap">   
	         ...
	         <!--start@recurring payment options-->
			<?php if($_SESSION['kr_recurring_order']['start_date']){ ?>			
			<hr>
	        <div class="item-recurring_item">
			<p class="center"><?php echo t("Your Recurring Orders Details")?></p>
			<div class="item-order-list item-row recurring-details">
