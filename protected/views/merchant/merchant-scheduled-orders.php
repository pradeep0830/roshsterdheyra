<div uk-grid>
    <div class="uk-width-1-4">
        <a href="<?php echo Yii::app()->request->baseUrl; ?>/merchant/scheduledorders" class="uk-button"><i class="fa fa-list"></i> <?php echo Yii::t("default","List")?></a>
    </div>
...
<form id="frm_table_list" method="POST" class="report uk-form uk-form-horizontal merchant-dashboard" >
    ...
    <input type="hidden" name="action" id="action" value="getMerchantScheduledOrders">
    <input type="hidden" name="tbl" id="tbl" value="item">
