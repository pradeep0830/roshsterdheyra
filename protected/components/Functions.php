	...
	public function merchantMenu()
	{
		...
		return array(  
		    ...
		    'items'=>array(
                ...
                array('visible'=>FunctionsV3::hasMerchantAccessToMenu($user_access,"RecurringOrders"),'tag'=>"RecurringOrders",'label'=>'<i class="fa fa-list-alt"></i>'.Yii::t("default","Recurring Meals"),
				'url'=>array('/merchant/recurringorders')),
				
                array('visible'=>FunctionsV3::hasMerchantAccessToMenu($user_access,"AllIncomingOrders"),'tag'=>"AllIncomingOrders",'label'=>'<i class="fa fa-list-alt"></i>'.Yii::t("default","Incoming Orders"),
                    'url'=>array('/merchant/allincomingorders')),
                    
                    array('visible'=>FunctionsV3::hasMerchantAccessToMenu($user_access,"ScheduledOrders"),'tag'=>"ScheduledOrders",'label'=>'<i class="fa fa-list-alt"></i>'.Yii::t("default","Scheduled Orders"),'url'=>array('/merchant/scheduledorders')),
                    
                    array('visible'=>FunctionsV3::hasMerchantAccessToMenu($user_access,"PickupOrders"),'tag'=>"PickupOrders",'label'=>'<i class="fa fa-list-alt"></i>'.Yii::t("default","Pick-up Orders"),'url'=>array('/merchant/pickuporders')),
                ...
                array('visible'=>FunctionsV3::hasMerchantAccessToMenu($user_access,"reports"),'tag'=>'reports','label'=>'<i class="fa fa-list-alt"></i>'.Yii::t("default",'Drivers'),
                    'itemOptions'=>array('class'=>''), 'items'=>array(
                    array('visible'=>FunctionsV3::hasMerchantAccessToMenu($user_access,"salesReport"),'tag'=>'salesReport','label'=>'<i class="fa fa-paypal"></i>'.Yii::t("default","Teams"),
                        'url'=>array('#')),
                    array('visible'=>FunctionsV3::hasMerchantAccessToMenu($user_access,"salesSummaryReport"),'tag'=>'salesSummaryReport','label'=>'<i class="fa fa-paypal"></i>'.Yii::t("default","Driver details"),
                        'url'=>array('#')),

                    array('visible'=>FunctionsV3::hasMerchantAccessToMenu($user_access,"bookingreport"),'tag'=>'bookingreport','label'=>'<i class="fa fa-paypal"></i>'.Yii::t("default","Driver Track Back"),
                        'url'=>array('#')),
                    array('visible'=>FunctionsV3::hasMerchantAccessToMenu($user_access,"bookingreport"),'tag'=>'bookingreport','label'=>'<i class="fa fa-paypal"></i>'.Yii::t("default","Task"),
                        'url'=>array('#')),
                    array('visible'=>FunctionsV3::hasMerchantAccessToMenu($user_access,"bookingreport"),'tag'=>'bookingreport','label'=>'<i class="fa fa-paypal"></i>'.Yii::t("default","Notifications"),
                        'url'=>array('#')),
                    array('visible'=>FunctionsV3::hasMerchantAccessToMenu($user_access,"bookingreport"),'tag'=>'bookingreport','label'=>'<i class="fa fa-paypal"></i>'.Yii::t("default","Assignment"),
                        'url'=>array('#')),
                )),
                end driver details*/
                ...
                array('visible'=>FunctionsV3::hasMerchantAccessToMenu($user_access,"review"),'tag'=>"review",'label'=>'<i class="fa fa-list-alt"></i>'.Yii::t("default","Driver reviews"),
