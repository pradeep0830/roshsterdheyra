...
<div id="translation-save-wrap"> 
  <a href="javascript:;" class="export-language btn btn-success"><?php echo t("Export")?></a>
  <a href="javascript:;" id="import-language" class="import-language btn btn-info"><?php echo t("Import")?></a>
  <a href="#main-wrapper" class="backtop btn btn-default"><?php echo t("Back to top")?></a>
  <a href="#bottom-trans" class="backtop btn btn-default"><?php echo t("Go to bottom")?></a>
  <?php
