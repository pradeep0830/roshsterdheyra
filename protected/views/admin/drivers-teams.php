<div class="uk-width-1">
    ...
    <a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/driverteam" class="uk-button"><i class="fa fa-list"></i> <?php echo Yii::t("default","List")?></a>
</div>

<form id="frm_table_list" method="POST" >
    <!--<input type="hidden" name="action" id="action" value="driverReviewRating">-->
    <input type="hidden" name="action" id="action" value="driverAjaxTeam">
    ...
    <table id="table_list" class="uk-table uk-table-hover uk-table-striped uk-table-condensed">
        ...
        <tr>
            ...
            <th width="10%"><?php echo Yii::t('default',"Team Name")?></th>
            <th width="5%"><?php echo Yii::t('default',"Total Driver")?></th>
