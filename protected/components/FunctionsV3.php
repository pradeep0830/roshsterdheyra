...
/*	public static function getItemFirstPrice($prices='',$discount='')
    ...
    // @sobhon get data for recurring order only
	public static function getItemNameRecurringOnly($order_id=''){
		$DbExt=new DbExt;
    	$stmt="
    	...
    	if ($res=$DbExt->rst($stmt)){
    		return $res[0]['item_name'];
    	}
    	//return false;
	}
	// @sobhon end get data for recurring order only
   ...
   public static function validateVoucherByAddress($voucher_code='', $street='', $city='', $state='')
   {
    ...
    public static function createTimeRange($start, $end, $interval = '30 mins', $format = '12') {
	    //$startTime = strtotime($start); 
            $startTime=strtotime("+45 minutes", strtotime($start)); 		
	    //$endTime   = strtotime($end);
	    $endTime =strtotime("-45 minutes", strtotime($end)); 
    ...
    public static function getTimeList($merchant_id='', $delivery_date='')
    {
    	$times = array(); 
		$date_now = date("Y-m-d");
		$time_start = '7:30'; $time_end = '18:30'; $interval = '1 mins';		
