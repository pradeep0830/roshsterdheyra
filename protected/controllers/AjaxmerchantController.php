...
class AjaxmerchantController extends CController
{
    ...
    public function actionuploadFile()
	{
			...
			// echo "actionuploadfilestartingggggggggggggggggggg";
		require_once('SimpleUploader.php');
		// echo "actionuploadfilestartingggggggggggggggggggg1111";
		if ( !Yii::app()->functions->isMerchantLogin()){	
			$this->msg = t("Session has expired");
			$this->jsonResponse();
		}
		// echo "actionuploadfilestartingggggggggggggggggggg2222";
		...
		// echo "actionuploadfilestartingggggggggggggggggggg33333";
		...
		// echo "actionuploadfilestartingggggggggggggggggggg44444";
		$field_name = isset($this->data['field'])?$this->data['field']:'';		
		
		$path_to_upload=Yii::getPathOfAlias('webroot')."/upload";
		//echo "\nactionuploadfilestartin777777777".$path_to_upload;
		$valid_extensions = FunctionsV3::validImageExtension();
		// echo "\nactionuploadfilestartin888888888".$path_to_upload;
        if(!file_exists($path_to_upload)) {	
           if (!@mkdir($path_to_upload,0777)){           	               	
	    ...
	    // echo "\n file upload startsssss";

		$Upload = new FileUpload('uploadfile');
		// echo "after file upload it not workingg";
        $ext = $Upload->getExtension(); 
		$time=time();
		// echo "\nactionuploadfilestartingggggggggggggggggggg55555";
		$filename = $Upload->getFileNameWithoutExt();  
		// echo "\nfilenameuploaddddddddddddddddddddddddddddddddd";  	   
