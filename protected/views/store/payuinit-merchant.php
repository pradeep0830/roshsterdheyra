...
if ( $data=Yii::app()->functions->getOrder($_GET['id'])){		
	...
	dump($amount_to_pay);*/
	if($_SESSION['kr_recurring_order']['start_date']){
			$amount_to_pay=$_SESSION['kmrs_subtotal'];
			//dump($amount_to_pay);die();
	}
    ...
    <div class="row top30">
       <div class="inner">
		  ...
		  //if($status=="success"){	
		    ...
		    $this->redirect( Yii::app()->createUrl('/store/receipt',array('id'=>$_GET['id'])) );
		    die();						
		  }
		  ?>
