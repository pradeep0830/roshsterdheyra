...
if (isset($is_merchant)){	
   ...
   $return_url=Yii::app()->getBaseUrl(true)."/store/payusuccess?id=".$_GET['id'];
  // $return_url_failed=Yii::app()->getBaseUrl(true)."/store/payusuccess/id/".$_GET['id']; 
   $return_url_failed=Yii::app()->getBaseUrl(true)."/store/payufail?id=".$_GET['id'];	
   
    //$return_url=Yii::app()->getBaseUrl(true)."/receipt?id=".$_GET['id'];    
   //$return_url=Yii::app()->getBaseUrl(true)."/store/payusuccess/id/".$_GET['id']; 
   //$return_url=Yii::app()->getBaseUrl(true)."/receipt?id=".$_GET['id']; 
} else {
...
<?php echo CHtml::hiddenField('furl',$return_url_failed)?>
...
<div class="row top10">
  ...
  <?php
   if(isset($_POST['firstname'])){
   echo CHtml::textField('firstname',
...
'required'=>true
	...
	echo CHtml::textField('phone',
	isset($_GET['phone'])?str_replace("+","",$_GET['phone']):''
	,array(
	'class'=>'grey-fields full-width',
	'data-validation'=>"required",
	'required'=>true
