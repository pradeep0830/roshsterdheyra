...

{
	...
	public function actionRecurringOrders()
	{
		$this->crumbsTitle=Yii::t("default","Recurring Order Details");
		if (isset($_GET['Do'])){
			$this->crumbsTitle=Yii::t("default","Recurring Order Add/Update");
			$this->render('recurring-order-list');		
		} else $this->render('recurring-order-list');
	}
	
	/**
     * Get the All order for Merchant
     * Query done in AjaxAdmain@getMerchantIncomingOrder
     */
    public function actionAllIncomingOrders(){
        $this->crumbsTitle=Yii::t("default","All Incoming Orders");
        $this->render('merchant-incoming-orders-list');
    }
    
    /**
     * Get Scheduled Orders for merchant
     * query done in AjaxAdmin@getMerchantScheduledOrders
     */

    public function  actionScheduledOrders(){
        $this->crumbsTitle=Yii::t('default',"All Scheduled Orders details");
        $this->render('merchant-scheduled-orders');
    }
    
    /**
     * Get Scheduled Orders for merchant
     * query done in AjaxAdmin@getMerchantPickupOrders
     */

    public function  actionPickupOrders(){
        $this->crumbsTitle=Yii::t('default',"All Pick-Up Orders details");
